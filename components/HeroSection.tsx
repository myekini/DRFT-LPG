  ...
  return (
    <section className="hero page-width" aria-labelledby="hero-heading">
      <div className="hero-copy">
        <h1 id="hero-heading">AI edits.<br />You <span className="headline-highlight"><BrandMark className="decide-mark" />decide.</span></h1>
        <p className="hero-body">A stronger resume. Still unmistakably you.<br />Chat, refine, and approve every change in one place.</p>
        <WaitlistForm />
        <p className="trust-line"><Check size={13} /> Early access <span>·</span> Free at launch <span>·</span> Open-source core</p>
      </div>
